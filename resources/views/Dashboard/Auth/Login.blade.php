                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 pl-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="#"
                                            class="noble-ui-logo d-block mb-2">MOOD<span><strong>APP</strong></span></a>
                                        ...
                                        <form class="forms-sample" action="{{ route('login') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputNumber"
                                                    placeholder="Entire phone number" name="phone"
                                                    value="{{ old('phone') }}">
                                                @error('phone')
                                            ...
                                            <a href="{{ route('register_page') }}" class="d-block mt-3 text-muted">Not a
                                                user? Sign
                                                up</a>
                                        </form>
                                    </div>
